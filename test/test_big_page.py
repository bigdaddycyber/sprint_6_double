import allure
import pytest
from pages.big_page import BigPage
...
class TestBigPage:
    ...
    def test_check_questions_and_answers(self, browser, num, result):
        big_page = BigPage(browser)
        big_page.click_to_cookie_button()
        big_page.scroll_to_questions()
        big_page.get_question(num)
        assert big_page.get_answer(num) == result